...
var etag = __webpack_require__(25);
...
const debug = __webpack_require__(0)('wiki-typescript:server');
const http = __webpack_require__(8);
const favicon = __webpack_require__(101);
const logger = __webpack_require__(102);
const cookieParser = __webpack_require__(105);
const bodyParser = __webpack_require__(106);
let app = express();
// view engine setup
...
//ここでfunctions.https.onRequest(app);を呼ぶのもありかも
...
var res = __webpack_require__(96);
...
mime.define(__webpack_require__(80));
...
var onFinished = __webpack_require__(7)
var onHeaders = __webpack_require__(104)
...
module.exports = {
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(51).concat(__webpack_require__(124)) },
